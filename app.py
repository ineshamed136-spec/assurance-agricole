...
# --- 1. FONCTION NASA POWER (Temps Réel) ---
...
with c2:
    if btn:
        ...
        with st.expander("🛠️ Fiche Technique"):
            ...
            st.json({"t": t, "pluie": pl, "taux": round(r, 2)})
