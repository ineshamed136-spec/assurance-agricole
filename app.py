...
def calculer_tout(sup, prod, irrig, cult, t, pl):
    ...
    risque = (0.7 * 27.5) + (0.3 * max(stress_h, stress_t)) 
...
st.title("🌾 Assurance Agricole 2026 - Tableau de Bord")
...
with c2:
    ...
    if btn:
        ...
        st.info(f"📍 Données météo (NASA) : Température={t:.1f}°C | Pluie={pl:.1f}mm")
        ...
        with st.expander("🛠️ Fiche Technique"):
            ...
            st.json({"t_celsius": t, "pluie_mm": pl, "taux_risque_final": round(r, 2)})
