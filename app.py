...
# 1. CONFIGURATION RÉGIONALE AVEC COORDONNÉES NASA
geo_conf = {
...
# 2. RÉCUPÉRATION RÉELLE DES DONNÉES NASA POWER
...
def get_nasa_data(lat, lon, mois):
    ...
    try:
        ...
        return 20.0, 30.0, 50.0, 5.0 # Valeurs par défaut si échec

# 3. CHARGEMENT MODÈLE (SÉCURISÉ)
@st.cache_resource
def load_model():
