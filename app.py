...
with col2:
    ...
    # Suppression du formatage de lien automatique
    ...
    if btn:
        ...
        with st.expander("ℹ️ Méthodologie et Logique Paramétrique"):
            ...
            * **Source des données :** Les paramètres climatiques sont appuyés par les données du projet NASA POWER (power.larc.nasa.gov).
